...
const ModuleProgressWidget = ({ totalLevels, levelsCompleted = 0, totalXp = 0 }) => {
    return (
        <div className="relative group w-fit md:w-auto rounded-2xl overflow-hidden transition-all hover:scale-[1.01]">
            ...
            <div className="relative z-10 h-full w-full rounded-2xl bg-black/20 backdrop-blur-xl border border-white/10 flex items-center gap-6 p-4">
                ...
                <div className="flex flex-col">
                    <p className="text-[10px] text-center font-bold uppercase tracking-widest text-white/40 mb-1">Levels Completed</p>
